package ro.ctce.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(ro.ctce.service.EmailAlreadyUsedException ex, NativeWebRequest request) {
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        ro.ctce.service.UsernameAlreadyUsedException ex,
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleInvalidPasswordException(ro.ctce.service.InvalidPasswordException ex, NativeWebRequest request) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "ro.ctce");
    }
}
